# this is telling the phython to access its library 
from tkinter import*
...
# this is a constructor that creates a function that lets my construct the application

cal=Tk()

# this lets me select my constructors title

cal.title("Calculator")

# this is an input prompt operator along with my constructor that will let my user type in numbers 
...
#These are different functions that tell python what my application should look like 
